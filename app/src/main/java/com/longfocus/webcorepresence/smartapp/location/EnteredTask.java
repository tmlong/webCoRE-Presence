...
public class EnteredTask extends AsyncTask<String, Void, Void> {

    private static final String TAG = EnteredTask.class.getSimpleName();

    private final OkHttpClient httpClient = new OkHttpClient();

    private final Registration registration;

    public EnteredTask(final Registration registration) {
